...
BRANCH_REGEX="${BRANCH_REGEX:-^(feature|enhancement|bugfix|hotfix|release|chore)/[a-z0-9._-]+$}"
...
echo "::error::Allowed prefixes: feature, enhancement, bugfix, hotfix, release, chore."
